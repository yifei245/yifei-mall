...
import com.yifei.mall.dao.CarouselMapper;
...
@Service
public class YifeiMallCarouselServiceImpl implements YifeiMallCarouselService {
    ...
    @Override
    public List<YifeiMallIndexCarouselVO> getCarouselsForIndex(int number) {
        List<YifeiMallIndexCarouselVO> yifeiMallIndexCarouselVOS = new ArrayList<>(number);
        List<Carousel> carousels = carouselMapper.findCarouselsByNum(number);
        if (!CollectionUtils.isEmpty(carousels)) {
            yifeiMallIndexCarouselVOS = BeanUtil.copyList(carousels, YifeiMallIndexCarouselVO.class);
        }
        return yifeiMallIndexCarouselVOS;
    }
}
