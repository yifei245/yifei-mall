...
import com.yifei.mall.controller.vo.YifeiMallGoodsDetailVO;
...
public class GoodsController {
    ...
    public String searchPage(@RequestParam Map<String, Object> params, HttpServletRequest request) {
        ...
        if (params.containsKey("goodsCategoryId") && !StringUtils.isEmpty(params.get("goodsCategoryId") + "")) {
            ...
            SearchPageCategoryVO searchPageCategoryVO = yifeiMallCategoryService.getCategoriesForSearch(categoryId);
        ...
        request.setAttribute("pageResult", yifeiMallGoodsService.searchYifeiMallGoods(pageUtil));
        return "mall/search";
    }
    ...
    public String detailPage(@PathVariable("goodsId") Long goodsId, HttpServletRequest request) {
        ...
        YifeiMallGoods goods = yifeiMallGoodsService.getYifeiMallGoodsById(goodsId);
        if (Constants.SELL_STATUS_UP != goods.getGoodsSellStatus()) {
            YifeiMallException.fail(ServiceResultEnum.GOODS_PUT_DOWN.getResult());
        }
        YifeiMallGoodsDetailVO goodsDetailVO = new YifeiMallGoodsDetailVO();
